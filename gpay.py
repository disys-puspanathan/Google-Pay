...
gpay = pay.Google_pay("puspanathang@gmail.com","8637635446","Puspanathan G")
gpay.open_gpay()
gpay.email_verification()
gpay.mobile_verification()
gpay.name_verification()
gpay.otp_verification(25695,25695)
gpay.bank_verification()
gpay.pancard_verification()
gpay.set_pin("1397")
gpay.enter_your_pin(3256,3256)

class Phone_pe(pay.Google_pay):
...
gpay = Phone_pe("puspanathang@gmail.com","8637635446","Puspanathan G")
gpay.open_phonepe()
gpay.mobile_verification()
gpay.name_verification()
gpay.otp_verification(870569,870569)
gpay.bank_verification()
gpay.pancard_verification()
gpay.set_pin("326598")
gpay.enter_your_pin(3256,3256)
